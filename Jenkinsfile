            ...
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                        ...
                        sh "cp  **/target/*.war ${params.tomcat_dev}:/Users/clemente.sanchez/Documents/DevTools/apache-tomcat-9.0.13-staging/webapps"
                    }
                }
                ...
                stage ("Deploy to Production"){
                    steps {
                        ...
                        sh "cp  **/target/*.war ${params.tomcat_prod}:/Users/clemente.sanchez/Documents/DevTools/apache-tomcat-9.0.13-prd/webapps"
